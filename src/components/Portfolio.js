...
export default function Portfolio() {
  ...
  return (
    <div className="   my-4  w-100 text-center m-auto animate__animated animate__fadeIn" id="portfolio">
      <div className="section">
      <div className="parallax2 parallax animate__animated animate__fadeIn "> 
      <h1 className={`title ${fontClass} p-3`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>WHAT HAVE I MADE? </h1> </div>
